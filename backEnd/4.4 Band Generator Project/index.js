...
app.post("/submit", (req, res) => {
  ...
  res.render("index.ejs", {name:band_name})
...
function generate_name() {
  var adj_length_index = adj.length;
  var noun_length_index = noun.length;
  var random_adj = adj[Math.floor(Math.random() * adj_length_index)];
  var random_noun = noun[Math.floor(Math.random() * noun_length_index)];
